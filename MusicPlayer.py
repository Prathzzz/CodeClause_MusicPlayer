...
window = tk.Tk()
window['background']= 'grey15'
window.title("˚⋆♡༘˚Music Player˚ ༘♡⋆˚")
...
btn_select_folder = ctk.CTkButton(window, text="Select Music Folder",
                                  ...
                                  font=("TkDefaultFont", 18),fg_color='grey15',text_color='sky blue')
btn_select_folder.pack(pady=20)

# Create a listbox to display the available songs
lbox = tk.Listbox(window, width=50, font=("TkDefaultFont", 16),bg='grey15')
lbox.pack(pady=10)

# Create a frame to hold the control buttons
btn_frame = tk.Frame(window,background='grey15')
btn_frame.pack(pady=20)

# Create a button to go to the previous song
btn_previous = ctk.CTkButton(btn_frame, text="⏪", command=previous_song,
                            width=50, font=("TkDefaultFont", 18),fg_color='grey15',text_color='sky blue')
...
btn_pause = ctk.CTkButton(btn_frame, text="⏸️", command=pause_music, width=50,
                          font=("TkDefaultFont", 18),fg_color='grey15',text_color='sky blue')
